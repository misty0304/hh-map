  ...
  methods: {
    initMap() {
      ...
      _this.map = new AMap.Map('container', {
        center: _this.positionLngLat.length ? _this.positionLngLat : _this.center, // 中心点,如果有标点传入优先使用标点
        resizeEnable: true,
      ...
      // 初始化定位标点
      if (_this.positionLngLat.length) {
        _this.marker = new AMap.Marker({
          position: _this.positionLngLat,
